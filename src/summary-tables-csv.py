"""
Create all summary tables for the Lithuanian Energy Analysis
Save as CSV files in results/tables/ directory
"""
...
print("✅ All 7 summary tables created in results/tables/")
print("\nTables created:")
for table in tables_dir.glob('*.csv'):
    print(f"  - {table.name}")
