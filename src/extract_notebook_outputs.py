...
extract_notebook_outputs('notebooks/lithuanian_energy_analysis.ipynb')
"""

if __name__ == "__main__":
    # If run as script, extract from lithuanian_energy_analysis notebook
    notebook_path = 'notebooks/lithuanian_energy_analysis.ipynb'
